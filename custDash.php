...
<head>
 ...
 ['class ShopName','CustomerID'],
 <?php 
      $query = "SELECT * from customer_12869";

       $exec = mysqli_query($db,$query);
       while($row = mysqli_fetch_array($exec)){

       echo "['".$row['ShopName']."',".$row['CustomerID']."],";
       }
       ?> 
...
<body>
<h3 style="text-align:centre;">Customers Pie Chart</h3>
<ul>
