...
<head>
 ...
 <?php 
      $query = "SELECT * from salesperson";
       ...
       echo "['".$row['Name']."',".$row['ListOfCustomers']."],";
       }
       ?> 
 ...
 var options = {
 title: 'Salesperson and list of customers of each Saleperson',
  pieHole: 0.5,
          pieSliceTextStyle: {
            color: 'black',
          },
...
<body>
<h3 style="text-align:centre;">Saleperson Dashboard</h3>
<ul>
